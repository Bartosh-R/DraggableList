...
package com.evilcorp.bartosh.draggablelistview;
...
public class DraggableListView extends ListView {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                if(handleId != NO_ID && isMobileCellAnimated == false) {
                    ...
                    if (mDownX > handleView.getLeft() && mDownX < handleView.getRight())
                        drag(selectedView, position);
                }
                break;
    ...
    boolean drag(View selectedView, int position){
        mTotalOffset = 0;

        Log.d("bartosh",selectedView.getId()+"");
    ...
    View getHandleView(View selectedView){
        int childCount = ((ViewGroup)selectedView).getChildCount();
        for(int i = 0; i< childCount; i++){
            View child = ((ViewGroup)selectedView).getChildAt(i);
            if(child.getId() == handleId) return child;
        }
        return null;
    }
    ...
    public void setList(ArrayList<String> cheeseList) {
        list = cheeseList;
    }

    public void setHandle(int id) { handleId = id; }
